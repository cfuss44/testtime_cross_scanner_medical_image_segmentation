...
def run_training():
    ...
    with tf.Graph().as_default():
        ...
        # ================================================================
        train_op_test_time = model.training_step(loss_self_supervised, test_time_opt_vars + self_supervised_vars, exp_config.optimizer_handle_test_time, learning_rate_pl)
        ...
        # ================================================================
        logging.info('============================================================')
        model_path = os.path.join(sys_config.log_root, 'Initial_training_rotation_joint')
